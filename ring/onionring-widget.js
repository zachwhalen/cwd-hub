...
<table>
  ...
  <table>
    <tr>
      <td class='webring-prev' style="width:25%"><a href='${sites[previousIndex]['URL']}'>${sites[previousIndex]['title']} <br/> &#8592;</a></td>
      <td class='webring-info'>This site is part of the ${ringName}</br>
      <span class='webring-links'>
        ${randomText}
        ${indexText}
        <a href='https://garlic.garden/onionring/'>what is this?</a></span><br/>
        <img src="https://garden.dgst101.net/eagles/eagle_soaring.gif" />
        </td>
      <td class='webring-next' style="width:25%"><a href='${sites[nextIndex]['URL']}'>${sites[nextIndex]['title']} <br/>&#8594;</a></td>
    </tr>
  </table>
  `);
